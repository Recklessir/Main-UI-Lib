...
local repo = "https://raw.githubusercontent.com/Recklessir/Main-UI-Lib/main/UILIB/"
...
-- Animated boot bar in the executor console, mirroring the on-screen loading steps below.
task.spawn(function()
    Library:PrintBootBar({
        { Percent = 0, Message = "Initializing..." },
        { Percent = 25, Message = "Loading configuration..." },
        { Percent = 55, Message = "Waiting for game to load..." },
        { Percent = 85, Message = "Ready to start!" },
...
MenuGroup:AddToggle("KeybindMenuOpen", {
	...
	Callback = function(value)
		Library:ToggleKeybindsFrame(value)
	end,
})
