...
local ThemeManager = {
    ...
    BuiltInThemes = {
        ["Default"] = {
            1,
            { FontColor = "ffffff", MainColor = "282828", AccentColor = "a3a3a3", BackgroundColor = "181818", OutlineColor = "282828", BackgroundImage = "", FontFace = "RobotoMono" },
        },
        ["BBot"] = {
            2,
...
function ThemeManager:ApplyTheme(ThemeName: string)
    ...
    for Index, Value in ThemeData do
        ...
        --// ThemeData may come from a hand-edited custom theme file on disk, so a bad
        --// hex string or font name must not abort applying the rest of the theme.
